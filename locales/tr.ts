...
export const tr = {
    ...
    // Game Screen
    transmissionIncoming: 'VERİ AKIŞI GELİYOR...',
    choice: 'SEÇİM',
    submit: 'GÖNDER',
    customChoicePlaceholder: 'Veya kendi eyleminizi yazın...',
    customActionPrefix: "Oyuncunun özel eylemi",
    transmissionEnded: 'Veri akışı sona erdi.',
    errorFetchStory: 'Hikayenizin bir sonraki bölümü getirilemedi. Lütfen tekrar deneyin.',

    // Game Over Screen
    outcomeVictoryTitle: 'GÖREV BAŞARILI!',
    outcomeVictoryMessage: 'Eylemleriniz kesin bir zafere yol açtı. Galaksi adınızı hatırlayacak.',
    outcomeDefeatTitle: 'GÖREV BAŞARISIZ',
    outcomeDefeatMessage: 'Cesurca savaştınız, ancak düşman güçlerinizi aştı. Hikayeniz burada sona eriyor.',
    outcomeOngoingTitle: 'BAĞLANTI KESİLDİ',
    outcomeOngoingMessage: 'Savaş devam ediyor...',
    playAgain: 'TEKRAR OYNA',

    // Options Menu
    optionsTitle: 'SEÇENEKLER',
    nicknameTitle: 'Komutan Takma Adı',
    nicknamePlaceholder: 'Çağrı kodunuzu girin...',
    save: 'KAYDET',
    languageTitle: 'Dil',
    transmissionSpeedTitle: 'Veri Akış Hızı',
    speedSlow: 'Yavaş',
    speedNormal: 'Normal',
    speedFast: 'Hızlı',
    speedInstant: 'Anında',
    ...
    vipCodeError: 'Geçersiz Kod',
    dangerZoneTitle: 'TEHLİKELİ BÖLGE',
    restartCampaign: 'SEFERİ YENİDEN BAŞLAT',
    clearSavedMission: 'KAYITLI GÖREVİ SİL',

    // Confirmation Modal
    confirmRestartTitle: 'Seferi Yeniden Başlat?',
    confirmRestartMessage: 'Yeniden başlatmak istediğinizden emin misiniz? Mevcut ilerlemeniz kaybolacak.',
    confirmClearSaveTitle: 'Kayıtlı Görevi Sil?',
    confirmClearSaveMessage: 'Kayıtlı oyun verilerinizi silmek istediğinizden emin misiniz? Bu işlem geri alınamaz.',
    cancel: 'İPTAL',
    confirm: 'ONAYLA',
